    ...
    <section >
        ...
        <section class="sec4_s">
            ...
            <div class="container custom_padding2">
                ...
                <div class="sec4_2">
                    <div class="sec4_crd">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/seo1.png') }}" alt="" class="img-fluid crd_image2 mobile_none">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/seo1_mob.png') }}" alt="" class="img-fluid crd_image2 desktop_none">
                        <div class="sec4_down">
                    ...
                    <div class="sec4_crd">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/seo2.png') }}" alt="" class="img-fluid crd_image2 mobile_none">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/seo2_mob.png') }}" alt="" class="img-fluid crd_image2 desktop_none">
                        <div class="sec4_down">
                    ...
                    <div class="sec4_crd">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/seo3.png') }}" alt="" class="img-fluid crd_image2 mobile_none">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/seo3_mob.png') }}" alt="" class="img-fluid crd_image2 desktop_none">
                        <div class="sec4_down">
            ...
            <div class="container custom_padding5">
                ...
                <div class="inner_sec5_ulta">
                    ...
                    <div class="right_sec5">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/seo_photo.png') }}" alt="" class="img-fluid mobile_none">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/seo_photo_mob.png') }}" alt="" class="img-fluid desktop_none">
                    </div>
                </div>
        ...
        <section class="sec7_s">
            ...
            <div class="insec7_s">
                ...
                <form class="form_section"id="requestform" action="{{ route('contactus.store') }}"
                ...
                <button class="btn btn_global form_btn_wid"  type="submit" form="requestform">
                    <img src="{{ asset('frontend/BrandSparkz/assets/img/btn_primary_pattern.png') }}" alt="" class="img-fluid btn_global_pattern">
                    <div class="btn_global_inner w-100">
