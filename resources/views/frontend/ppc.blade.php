...
<section >
        ...
        <section class="sec1_s">
            <video class="bg-image d-lg-block d-md-block d-none" loop="" muted="" autoplay=""
                ...
                <source src="{{ asset('frontend/BrandSparkz/assets/img/ppc.mp4') }}" type="video/mp4">
            </video>
            <video class="bg-image d-lg-none d-md-none d-block" loop="" muted="" autoplay="" style="object-fit: cover;">
                <source src="{{ asset('frontend/BrandSparkz/assets/img/ppc_mob.mp4') }}" type="video/mp4">
            </video>
        ...
        <section class="sec2_s">
            <img src="{{ asset('frontend/BrandSparkz/assets/img/intersect_tt.png') }}" alt="" class="img-fluid intersect_tt mobile_none"style="height: 82px;">
        ...
        <section class="sec4_s">
            ...
            <div class="container custom_padding2">
                ...
                <div class="sec4_2">
                    <div class="sec4_crd">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc1.png') }}" alt="" class="img-fluid crd_image2 mobile_none">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc1_mob.png') }}" alt="" class="img-fluid crd_image2 desktop_none">
                        <div class="sec4_down">
                    ...
                    <div class="sec4_crd">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc2.png') }}" alt="" class="img-fluid crd_image2 mobile_none">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc2_mob.png') }}" alt="" class="img-fluid crd_image2 desktop_none">
                        <div class="sec4_down">
                    ...
                    <div class="sec4_crd">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc3.png') }}" alt="" class="img-fluid crd_image2 mobile_none">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc3_mob.png') }}" alt="" class="img-fluid crd_image2 desktop_none">
                        <div class="sec4_down">
            ...
            <div class="container custom_padding5">
                ...
                <div class="inner_sec5">
                    ...
                    <div class="right_sec5">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc_photo.png') }}" alt="" class="img-fluid mobile_none">
                        <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc_mob_photo.png') }}" alt="" class="img-fluid desktop_none">
                    </div>
                </div>
        ...
        <section class="sec8_s" id="targetDiv">
            ...
            <div class="for_below_table ppc_width mx-auto">
    ...
    <section class="sec7_s">
        ...
        <div class="insec7_s">
            ...
            <form class="form_section"id="requestform1" action="{{ route('contactus.store') }}"
                        ...
                        <div class="c-checkbox">
                            ...
                            <div class="c-text">
                                <p class="login_strong">By ticking this box, you agree to the<br> <span
                                        class="blue_text">Terms & Conditions</span> & <span class="blue_text">Privacy
                                        Policy</span></p>
                            </div>
                        </div>
