...
<section>
    ...
    <section class="sec4_s">
        ...
        <div class="container custom_padding2">
            ...
            <div class="sec4_2">
                <div class="sec4_crd">
                    <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc1.png') }}" alt=""
                ...
                <div class="sec4_crd">
                    <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc2.png') }}" alt=""
                        class="img-fluid crd_image2 mobile_none">
                ...
                <div class="sec4_crd">
                    <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc3.png') }}" alt=""
                        class="img-fluid crd_image2 mobile_none">
        ...
        <div class="container custom_padding5">
            ...
            <div class="inner_sec5">
                ...
                <div class="right_sec5">
                    <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc_photo.png') }}" alt=""
                        class="img-fluid mobile_none">
                    <img src="{{ asset('frontend/BrandSparkz/assets/img/ppc_mob_photo.png') }}" alt=""
