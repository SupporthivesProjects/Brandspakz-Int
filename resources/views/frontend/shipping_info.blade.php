        ...
        <div class="term2_main SCmain">
            <div class="secure_div1">
                <div class="secure_top">
                    ...
                    <from class="inputSC_main" id="shippingAddress" data-toggle="validator" action="{{ route('checkout.store_shipping_infostore') }}" role="form"
                        ...
                        <input type="hidden" class="form-control" form="shippingAddress" name="email" value="{{ $user->email }}" required/>
                    ...
                    <div class="bottomSC_main">
                                    ...
                                    <tbody>
                                       ...
                                       @endforeach
                                        <tr>
                                            ...
                                            <td>
                                                <p class="for_total for_bottom">{{ currency_symbol() . number_format($subtotal, 2) }}</p>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                        ...
                        <div class="bottomSCauth">
                            <div class="bottomdiv_authe">
                                <input type="checkbox" class="checkbox_SC" id="terms" name="terms" form="shippingAddress">
                                <p class="para_checkboxSC">By ticking this box, you agree to the
                                    <span><a href="{{ route('termsandconditions') }}">Terms & Conditions</a> </span> & <span><a href="{{ route('privacypolicy') }}"> Privacy Policy</a></span></p>
                            </div>
